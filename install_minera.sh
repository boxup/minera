...
MINER_OPT="--gc3355-detect --gc3355-autotune --freq=850 -o stratum+tcp://multi.ghash.io:3333 -u coinbuy247.minera -p x --retries=1"
...
echo -e '[{"url":"stratum+tcp://multi.ghash.io:3333","username":"coinbuy247.minera","password":"x"}]'  | redis-cli -x set minerd_pools
